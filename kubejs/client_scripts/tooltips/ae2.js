addTooltip(
  ["ae2:toggle_bus", "ae2:inverted_toggle_bus"],
  "A _network cable_ that allows its connection state to be _toggled_ via _redstone._ This allows you to cut off a section of a ME Network. When _redstone signal_ supplied the part enables the connection, _ME Inverted Toggle Bus_ provides the reverse behavior by disabling the connection instead."
);
addTooltip(
  "ae2:storage_bus",
...
addTooltip(
  ...
  "The primary way of obtaining _quartz_ is from breaking _quartz crystal clusters_. These grow on _budding quartz_ Which, after it decays can be recharged using _Polished Rose Quartz_ in a puddle of water. New _budding quartz_ can be created the same way by using a _Block of Quartz_."
);
