...
addToTag('forge:bushes', [
    'dead_bush',
    'fern',
    'rose_bush'
])
addToTag('forge:dusts/sugar', 'sugar')
addToTag('forge:meat', ['minecraft:beef', 'minecraft:chicken', 'minecraft:porkchop', 'minecraft:rabbit', 'minecraft:mutton', 'minecraft:cod', 'minecraft:salmon'])
addToTag('forge:lime', 'create:limesand')
addToTag('forge:acidic', [
    'botania:fel_pumpkin'
])
