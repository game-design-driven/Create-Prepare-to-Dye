...
val tipsToAdd ={
    <item:supplementaries:planter> :"Allows to grow crops without needing water or the risk of being trampled on. Grow crops in the nether.",
    ...
    <item:supplementaries:notice_board> :"Insert a book and quill in it and the it will display the contents of the first page. You can interact using hoppers. Can also store maps and banner patterns",
    <item:supplementaries:safe> :"An upgraded shulker box that is immune to fire.",
    <item:supplementaries:cage> :"Stores a mob inside it when you right or left click a mob. Can only catch small animals. Right click the ground to release. sneak right click to place.",
    <item:supplementaries:jar> :"Can store 4 buckets or 12 bottles or 6 bowls of any fluid including potions. Cookies can be stored. To eat or drink right click with an empty hand. Right-click small mobs to capture and sneak right-click to place. Right-click the ground To release. Right-click water buckets with captured fish on the jars to place.",
    <item:supplementaries:jar_tinted> :"Can capture vexes and endermites. Sneak right-click to place it down.  Right-click on the ground To release.",
    <item:supplementaries:firefly_jar> :"Light source. Click a firefly with an empty jar. Can't be released.",
    <item:supplementaries:soul_jar> :"Light source. Use a tinted jar on soul sand while wearing soul speed boots to capture a soul. Can't be released.",
    <item:supplementaries:sack> :"An early game shulker box. Can only carry a maximum of two. Carry 3 or more and you will be slowed by their weight. Sacks will react to gravity. Place a block either under it or above it to keep from falling.",
    <item:supplementaries:blackboard> :"Draw on it in. It will keep what's drawn on it once broken and you'll be able to duplicate your masterpieces just like you can with banners. Craft them with a water bucket to clear them in bulk. They can also be edited by holding a dye or a sponge to clear it all",
    ...
    <item:supplementaries:copper_lantern> :"Can be turned off and on with an empty hand and a flint and steel.",
    ...
    <item:supplementaries:doormat> :"A hybrid between a sign and a carpet. Cats love to sit on it from time to time. You can also hide one item under a carpet by sneak clicking on its side",
    ...
    <item:supplementaries:pulley_block> :"A single slot inventory that accept a stack of ropes or chains. Once rotated with a turn table it will start deploying or pulling back the block underneath it. You can also activate it manually by sneak clicking on a rope that's attached to it or via a crank attached to it",
    <item:supplementaries:flower_box> :"Plant flowers",
    <item:supplementaries:statue> :"A decorative item",
    <item:supplementaries:piston_launcher> :"It pushes entities about twice as far as the vanilla piston-slime block setup. Additionally can propel you upwards if you were to fall directly on it when enough force is provided to contract it, provided it's extended. Try it out, it's really fun!",
    ...
    <item:supplementaries:crank> :"The Crank is basically the more powerful version of the lever that lets you choose between 16 different power states as you turn it. Sneak right click to reverse the turning direction",
    <item:supplementaries:wind_vane> :"Swings depending on the current weather. The wind vane also outputs a redstone signal, the strength of it depending on the weather. When raining, the strength is 1, while when thundering, the strength is 2. The block will also provide strong power to the block below",
    ...
    <item:supplementaries:key> :"If you click on a safe with a named key the safe will be bound to that key name and will only be able to be opened when a player has a key with the same name in his inventory. To unbind a key simply sneak click with it on its safe.",
    ...
    <item:supplementaries:hanging_sign_acacia> :hanging_sign_text,
    <item:supplementaries:blackstone_tile_vertical_slab> :"A decorative block",
    <item:supplementaries:blackstone_tile_slab> :"A decorative block",
    <item:supplementaries:blackstone_tile> :"A decorative block",
    <item:supplementaries:stone_tile_vertical_slab> :"A ddecorative block",
    <item:supplementaries:stone_tile_slab> :"A decorative block",
    <item:supplementaries:stone_tile> :"A decorative block",
    ...
    <item:supplementaries:timber_cross_brace> :"A decorative block",
    <item:supplementaries:timber_brace> :"A decorative block",
    <item:supplementaries:timber_frame> :"A decorative block",
    <item:supplementaries:daub_cross_brace> :"A decorative block",
    <item:supplementaries:daub_brace> :"A decorative block",
    <item:supplementaries:daub_frame> :"A decorative block",
    <item:supplementaries:daub> :"A decorative block",
    <item:supplementaries:flax_block> :"A decorative block",
    <item:supplementaries:fodder> :"Can be eaten indefinitely by sheeps and also speeds up their wool regrowth",
    <item:supplementaries:checker_vertical_slab> :"A decorative block",
    <item:supplementaries:checker_slab> :"A decorative block",
    <item:supplementaries:checker_block> :"A decorative block",
    <item:supplementaries:blackstone_lamp> :"A decorative block and a light source",
    <item:supplementaries:stone_lamp> :"A decorative block and a light source",
