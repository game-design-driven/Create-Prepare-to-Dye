...
val tipsToAdd ={
    ...
    <item:supplementaries:jar> :"Can store 4 buckets or 12 bottles or 6 bowls of any fluid including potions. Cookies can be stored. To eat or drink right click with an empty hand. Right-click small mobs to capture and shift right-click to place. Right-click To release.",
