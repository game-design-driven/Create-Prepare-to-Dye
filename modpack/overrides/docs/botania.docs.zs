...
val blood_pendants = "Gives the potion effect infused into the pendant. takes 10 times as much Mana as brewing a vial.";
...
val tipsbotania ={
    ...
    <item:botania:corporea_retainer> :"Works with an Interceptor. When an Interceptor is triggered, it will remember the request. Can only hold one request at a time and stops accepting more. When it receives a Redstone signal, it will cause the original requestor to resend. A Comparator attached will emit a signal of 15 when a request is stored.",
    <item:botania:corporea_crystal_cube> :"Displays an amount of an item and requests it from the network. Right-click with an item to set to display it's amount. Left-click to request 1 item from the network. Shift left-click will request a stack. A Redstone Comparator will emit a signal according to the amount of items inside.",
    <item:botania:corporea_interceptor> :"When an item is requested but can't be supplied, it will emit a 2-tick Redstone pulse if any item frames matches the request. If a Corporea Retainer is next to it, it can store the request to resend it later. connects to the network with a Corporea Spark on top. Item Frames with items must be placed to define what triggers it.",
    <item:botania:corporea_funnel> :"Pulls items from a Corporea network with redstone signals. When powered, it requests an item from the network, then places it in an inventory 1 or 2 blocks below it. If the inventory is full, the item will be tossed above. Only pulls items matching Item Frames on its sides. The amount is changed by rotating the item inside the frame - by default its one item, rotating will pull 2, 4, 8, 16, 32, 48, or 64 items.",
    <item:botania:corporea_index> :"Intercepts players' chat messages in a 2.5 block radius to request items out of a Corporea network. 'this' requests the held item.",
    //mana stuff
    <item:botania:mana_pool> :"Can store an extremely large amount of Mana.  Inserted Mana into the Mana Pool via a Mana Spreader, and any adjacent Mana Spreaders will pull Mana from it.  Right-click with a Wand of the Forest to display the amount of Mana inside. Throw resources inside to infuse them with mana. ",
    <item:botania:diluted_pool> :"Can hold about 1% of what the normal Mana, and cannot infuse items.",
    <item:botania:mana_spreader> :" Transports Mana. Direct with the Wand of the Forest by sneak-right click on it, or by sneak right-click on it then sneak right-click on another block to direct it there. The Mana bursts can only travel a distance of 12 blocks before beginning to loss some Mana. Can be turned on and off with a redstone signal.",
    <item:botania:redstone_spreader> :"Transports Mana. will only emit Mana once per redstone pulse. The Mana bursts can only travel a distance of 12 blocks before beginning to loss some Mana.",
    <item:botania:elven_spreader> :"Allows for Mana bursts to travel up to 20 blocks without losing Mana, also fires Mana at a faster rate.",
    <item:botania:gaia_spreader> :"Allows for Mana bursts to travel up to 48 blocks without losing Mana, but fires Mana bursts less frequently.",
    <item:botania:spark> :"Transports large amounts of Mana. Placed on top of Mana Pools, Terrestrial Agglomeration Plates and Mana Enchanters, by right-clicking them. Has a 25x25x25 functional range. Sneak right-clicking with a Wand of the Forest will pick it up. If the Spark is augmented, it will remove the augment instead.",
    <item:botania:spark_upgrade_dispersive> :"Transfers Mana from the Mana Pool below to Mana storage items in inventories of players in a 25x25x25 area. Can be applied by right-clicking a Spark, or powering a Spark Tinkerer adjacent to the block the Spark is attached to with a redstone signal.",
    <item:botania:spark_upgrade_dominant> :"Pulls Mana from other Mana Pools with Sparks in a 25x25x25 area. Can be applied by right-clicking a Spark, or powering a Spark Tinkerer adjacent to the block the Spark is attached to with a redstone signal.",
    <item:botania:spark_upgrade_recessive> :"Pushs Mana into other Mana Pools with Sparks in a 25x25x25 area. Can be applied by right-clicking a Spark, or powering a Spark Tinkerer adjacent to the block the Spark is attached to with a redstone signal.",
    <item:botania:spark_upgrade_isolated> :"Prevents from interacting with Dominant or Recessive Sparks. It will still be able to provide Mana to other Mana using blocks. Can be applied by right-clicking a Spark, or powering a Spark Tinkerer adjacent to the block the Spark is attached to with a redstone signal.",
    <item:botania:spark_changer> :"Used to change Spark Augments on nearby Sparks. Can hold a single Spark Augment. When it receives a redstone signal, it will swap the held item with a Spark on an adjacent block.",
    <item:botania:mana_distributor> :"When it receives a burst it will equally share all the Mana between the Mana Pools adjacent to it.",
    <item:botania:mana_void> :"Any Mana shot into it will vanish. Placing the Mana Void under a Mana Pool allows the pool to always accept Mana but dispose of any it cannot hold.",
    <item:botania:mana_detector> :"Mana bursts will travel through this block, When that happens it will provide a Redstone signal. ",
    <item:botania:mana_fluxfield> :"Converts Mana into Redstone Flux (RF).",
    <item:botania:prism> :"Right clicking it with a Mana Lens will put it on the prism. When a Mana burst passes through it, it will lose all special properties, and effects from the lens on the prism will be applied. Applying a Redstone signal will disable the prism.",
    <item:botania:pump> :"Used to transfer Mana between Mana Pools and Minecarts with Mana Pool. Transfers Mana from the container on its blue side to the one on the pink side until it's full, excess Mana will be lost. A Redstone signal will disable it. A Redstone Comparator will output a signal proportional to how much Mana is in the minecart.",
    <item:botania:bellows> :"Each bellows will increase the Mana transfer rate from a facing Mana Pool to dropped items. If placed facing a Furnace, right-clicking on the Bellows will cause the furnace to smelt items 5 times faster and with an 80% efficiency increase.",
    <item:botania:pool_minecart> :"Transport large amounts of Mana via rail. Mana can be transferred between a Mana Pool and the minecart with a Mana Pump.",
    //lenses
    <item:botania:lens_normal> :"Can be modified in color and effect. Color by crafting with a dye, for rainbow-colored craft with a Mana Pearl.",
    <item:botania:lens_speed> :"Doubles the speed of Mana bursts but each burst holds 25% less Mana and starts to decay after 8 blocks, losing Mana twice as fast.",
    <item:botania:lens_power> :"Doubles the amount of Mana a Mana burst can carry, but the burst's speed is slightly lowered and when it starts to decay it will lose Mana twice as fast.",
    <item:botania:lens_time> :"Make the Mana burst begin decaying twice as long as it usually does, however the burst will be 20% slower.",
    <item:botania:lens_efficiency> :"Increases the time before the Mana bursts start to decay by 10%, and makes the decay 5 times slower.",
    <item:botania:lens_bounce> :"Mana bursts will be able to bounce off walls instead of dissipating on collision.",
    <item:botania:lens_gravity> :"Mana bursts will be affected by gravity and last 20% longer before starting to decay.",
    <item:botania:lens_mine> :"Break blocks they collide with. When combined with the Warp lens into: Bore Warp, Force Relays and Pistons will not be broken and all mined blocks will be teleported to the spreader's location.",
    <item:botania:lens_damage> :"Mana bursts will deal 8 points of damage to mobs.",
    <item:botania:lens_phantom> :"Mana bursts will be able to go through blocks, they starts to decay sooner by 4 ticks for every tick spent inside a block.",
    <item:botania:lens_magnet> :"Mana bursts will be attracted by Mana Pools and Spreaders in a 3 block range that can accept more Mana. The burst will be slowed near them.",
    <item:botania:lens_explosive> :"Mana bursts will explode if they collide with a block that cannot accept Mana. The power is proportional to the amount of Mana.",
    <item:botania:lens_influence> :"Mana bursts will cause nearby items, experience orbs, falling blocks and other Mana bursts to move in the same vector as the burst.",
    <item:botania:lens_weight> :"Mana bursts will turn the block they collide with into a falling block. The block must be able to be mined by an Iron Pickaxe, be affected by Silk Touch, directly above an air block, and cannot be a tile entity.",
    <item:botania:lens_paint> :"Mana bursts will color nearby sheep or colored blocks. It needs to be dyed. If rainbow-colored (Mana Pearl) each affected block or sheep will be dyed to a random color. When a sheep is hit, all sheep of the same color in a 20 block radius will be dyed to the color of the lens. When colored blocks are hit, up to 1,000 connected blocks of the same type and color will be dyed.",
    <item:botania:lens_fire> :"Mana bursts will set the hit block on fire. If a Nether Portal is hit it will be closed. Will ignite a full incense Plate.",
    <item:botania:lens_piston> :"Mana bursts will push the hit block (if it can be pushed by a Piston). Can only move one block at a time.",
    <item:botania:lens_light> :"Mana bursts will create a decorative Mana Flash of the same color. This block emits a light level of 15. Fire again to put out.",
    <item:botania:lens_warp> :"When a Mana burst collides with a Force Relay the burst will be teleported to the relay's bound location. After a burst is teleported it cannot transfer Mana to Mana Pools or Spreaders.",
    <item:botania:lens_redirect> :"Mana bursts will make the Mana Spreaders they collide with point towards the burst's source. Does not work with a Mana Blaster.",
    <item:botania:lens_firework> :"The bursts it fires will spawn a Firework Rocket on hitting a block.",
    <item:botania:lens_flare> :"Creats a continuous particle burst in the color of the lens for no Mana cost. It has no effect on Mana Prisms, and cannot be put on a Mana Blaster. Composite lenses made with this lens as the secondary one will not have this effect. This lens cannot be combined with the Tripwire lens. passes through blocks.",
    <item:botania:lens_messenger> :"Mana bursts will travel 3 times as fast and last 3 times as long before decaying, but have only 1/5 of the standard capacity.",
    <item:botania:lens_tripwire> :"Only fires a Mana bursts if there's at least one player or mob in the burst's path. Composite Lenses made with this lens as the secondary will not have this effect. It has no effect on Mana Prisms, and cannot be put on a Mana Blaster",
    //magic flowis
