...
public expand Recipes{
    ...
    public static addInfusion(output as IItemStack, input as IIngredient, catalyst as StateIngredient = <blockstate:create:andesite_casing>,mana as int = 1000) as void{
